                                                ...
                                                if( $rp_query -> have_posts() ){
                                                    while( $rp_query -> have_posts() ){
                                                        ...
                                                        ?>
                                                            ...
                                                            if( has_post_thumbnail() ){
                                                                //  $james = the_post_thumbnail('medium'); 
                                                                //  $jessica = has_post_thumbnail(); //whether post has no feautered image this is always true because of theme support thumbnails
                                                                ?>
                                                                <div class="entry-image">
                                                                <a href="<?php the_permalink(); ?>">
